...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // already taken, rather than leaking that the account exists.
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      // verifyOtp persists the session itself, so we can go straight in.
      window.location.href = safeReturnTo();
    } catch (err) {
    ...
    return (
      ...
      >
        ...
        <p className="text-center text-xs text-muted-foreground mb-4">
          Enter the 6-digit code from the email, or just tap the link inside it.
        </p>
